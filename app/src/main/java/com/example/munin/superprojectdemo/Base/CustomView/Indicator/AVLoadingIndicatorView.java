package com.example.munin.superprojectdemo.Base.CustomView.Indicator;
...
import com.example.munin.superprojectdemo.Base.CustomView.Indicator.indicators.BallPulseIndicator;
import com.example.munin.superprojectdemo.R;

//有反射调用工程的名字从而找到该类，从而实现它
