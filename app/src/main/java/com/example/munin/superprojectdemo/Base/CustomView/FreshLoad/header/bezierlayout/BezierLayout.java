package com.example.munin.superprojectdemo.Base.CustomView.FreshLoad.header.bezierlayout;
...
import com.example.munin.superprojectdemo.Base.CustomView.FreshLoad.IHeaderView;
...
public class BezierLayout extends FrameLayout implements IHeaderView {
    ...
    private void init(AttributeSet attrs) {
         ...
         * 初始化headView
         */
        headView = LayoutInflater.from(getContext()).inflate(R.layout.fresh_load_view_bezier, null);
